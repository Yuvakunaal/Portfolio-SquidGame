      ...
      <nav className="fixed top-0 left-0 right-0 z-40 glass-red">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <div className="text-2xl font-orbitron font-black neon-text cursor-hover">
              PLAYER 456
            </div>
            ...
            <button
              ...
              className="md:hidden text-squid-white cursor-hover"
            >
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden glass-red transition-all duration-300 ${isMobileMenuOpen ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
